...
class TriageBrainOffline{
  ...
  Future submit(bool yesState,String employeeNum,String firstName,String lastName,String barangay,String municipality,String department,String plant,String manager,String travelMode,String route,String temperature,String time1,String time2,String seatNumber, String busNumber,
  String _answer1,String _answer2,String _answer3,String _answer4,String _answer5,String _answer6,String _answer7,String _answer8,String _ans6Place,
  ...
  bool _part2Check1,bool _part2Check2,bool _part2Check3,bool _part2Check4,bool _part2Check5,String _specificAllergy) async{
    ...
    try{
            ...
            DocumentReference records = Firestore.instance.collection('Shuttle').document('${DateFormat.d().format(now)}-${DateFormat.M().format(now)}-${DateFormat.y().format(now)}-$time2-$employeeNum-offline');
            ...
            await records.setData({
              ...
              'emailSend' : yesState == true ? 'no' : 'yes',
              'triageState'  : 'yes',
              'date' : date,
              'timeIn' : time2,
              'timeOut' : time1,
  ...
  Future submitLobby(bool yesState,String employeeNum,String firstName,String lastName,String barangay,String municipality,String department,String plant,String manager,String transpoMode,String lobbyNum,String temperature,String time2,
  String _answer1,String _answer2,String _answer3,String _answer4,String _answer5,String _answer6,String _answer7,String _answer8,String _ans6Place,
  bool _check1,bool _check2,bool _check3,bool _check4,bool _check5,bool _check6,bool _check7,bool _check8,bool _check9,bool _check10,bool _check11,String _otherSymptom,
  bool _part2Check1,bool _part2Check2,bool _part2Check3,bool _part2Check4,bool _part2Check5,String _specificAllergy) async {
    String result;
    try{
            var now = new DateTime.now();
            DocumentReference records = Firestore.instance.collection('Lobby').document('${DateFormat.d().format(now)}-${DateFormat.M().format(now)}-${DateFormat.y().format(now)}-$time2-$employeeNum-offline');
            String date = DateFormat.yMd().format(now);
            Firestore.instance.settings(persistenceEnabled: true);
            await records.setData({
              'documentId' : '${DateFormat.d().format(now)}-${DateFormat.M().format(now)}-${DateFormat.y().format(now)}-$employeeNum',
