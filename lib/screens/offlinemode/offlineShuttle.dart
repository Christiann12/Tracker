...
class OfflineShuttle extends StatefulWidget {
  @override
  _OfflineShuttleState createState() => _OfflineShuttleState();
}

class _OfflineShuttleState extends State<OfflineShuttle> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Offline Shuttle Input'),
